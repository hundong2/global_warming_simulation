...
export const layerDetails = {
  ...
  sea: {
    ...
    text: '밝은 해안선은 해수면 상승을 강조한 기호입니다. 지역별 침수 면적은 계산하지 않습니다. 확대 단면의 점선과 푸른 띠를 비교해 물높이 차이를 확인하세요.',
  ...
  ice: {
    ...
    text: '흰 입체 기호는 대표 빙하 지역, 노란 윤곽은 2015년 기준 모습입니다. 크기는 전 세계 평균 질량의 개념 표현이며 개별 빙하의 예측 면적이 아닙니다. 극지 빙상은 고정합니다.',
